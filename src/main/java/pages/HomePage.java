...
public class HomePage extends BasePage{
    ...
    public String check_Homepage_Title(){
    ...
    public void click_On_Filter_Field() {
    ...
    public void click_On_Price_High_To_Low() {
    ...
    By linkNameProduct3 = By.id("item_1_title_link");
    By linkNameProduct4 = By.id("item_5_title_link");
    By linkNameProduct5 = By.id("item_2_title_link");
    By linkNameProduct6 = By.id("item_3_title_link");
    ...
    public boolean sort_Products_By_Name_From_Z_To_A() {
        ...
        for(String itemN:obtainedList) {
            sortedList.add(itemN);
        }
    ...
    public boolean sort_Products_By_Price_From_Low_To_High() {
        ...
        for(WebElement item:itemsPrices) {
            ...
            Float convertedInt = Float.valueOf(without$);
            obtainedList.add(convertedInt);
        }

        ArrayList<Float> sortedList = new ArrayList<>();
        for(Float itemP:obtainedList) {
            sortedList.add(itemP);
        }
    ...
    public boolean sort_Products_By_Price_From_High_To_Low() {
        ...
        for(WebElement item:itemsPrices) {
            String name = item.getText(); // 122 abc
            String without$ = name.substring(1);
            Float convertedInt = Float.valueOf(without$);
            obtainedList.add(convertedInt);
        }
...
//    public boolean check_Names_Of_Add_To_Cart_Buttons_After_Click() throws InterruptedException {
//        List<WebElement> addToCartButtons = driver.findElements(By.cssSelector("[class='btn btn_primary btn_small btn_inventory']"));
//
//        for (WebElement addToCart:addToCartButtons) {
//            addToCart.click();
//            Thread.sleep(500);
//            if (addToCart.getText() != "Remove") {
//                return false; //
//            }
//        }
//        return true;
//    }
    ...
    By AddToCartButton3 = By.id("add-to-cart-sauce-labs-bolt-t-shirt");
    By AddToCartButton4 = By.id("add-to-cart-sauce-labs-fleece-jacket");
    By AddToCartButton5 = By.id("add-to-cart-sauce-labs-onesie");
    By AddToCartButton6 = By.id("add-to-cart-test.allthethings()-t-shirt-(red)");

    public void click_On_First_Add_To_Cart_Button() {
        driver.findElement(AddToCartButton1).click();
    }
    public void click_On_Second_Add_To_Cart_Button() {
        driver.findElement(AddToCartButton2).click();
    }
    public void click_On_Third_Add_To_Cart_Button() {
        driver.findElement(AddToCartButton3).click();
    }
    public void click_On_Fourth_Add_To_Cart_Button() {
        driver.findElement(AddToCartButton4).click();
    }
    public void click_On_Fifth_Add_To_Cart_Button() {
        driver.findElement(AddToCartButton5).click();
    }
    public void click_On_Sixth_Add_To_Cart_Button() {
    ...
    By RemoveButton3 = By.id("remove-sauce-labs-bolt-t-shirt");
    By RemoveButton4 = By.id("remove-sauce-labs-fleece-jacket");
    By RemoveButton5 = By.id("remove-sauce-labs-onesie");
    By RemoveButton6 = By.id("remove-test.allthethings()-t-shirt-(red)");

    public void click_On_First_Remove_Button() {
        driver.findElement(RemoveButton1).click();
    }
    public void click_On_Second_Remove_Button() {
        driver.findElement(RemoveButton2).click();
    }
    public void click_On_Third_Remove_Button() {
        driver.findElement(RemoveButton3).click();
    }
    public void click_On_Fourth_Remove_Button() {
        driver.findElement(RemoveButton4).click();
    }
    public void click_On_Fifth_Remove_Button() {
        driver.findElement(RemoveButton5).click();
    }
    public void click_On_Sixth_Remove_Button() {
    ...
    public void click_On_First_Product_LinkName() {
        driver.findElement(linkNameProduct1).click();
    }
    ...
    public void click_On_Image_Of_Second_Product() {
        driver.findElement(imageProduct2).click();
    }
